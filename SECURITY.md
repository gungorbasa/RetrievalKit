...
RetrievalKit has not published a supported binary release yet. Security fixes are
...
Please use [GitHub's private vulnerability reporting](https://github.com/gungorbasa/RetrievalKit/security/advisories/new).
...
RetrievalKit validates persisted checksums and fails closed on corrupt snapshots,
