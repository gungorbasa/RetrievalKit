...
use retrievalkit_core::ChunkIdentity;
...
fn execute_run_with_persistence_and_failures(
    ...
    let temporary = TemporaryDirectory::new("retrievalkit-v3-phase-1-2b-persistence")?;
...
mod tests {
    ...
    use retrievalkit_core::{CorpusId, RecordInput, RetrievalKitError};
