...
/// Runs RetrievalKit's synthetic device benchmark and returns a heap-allocated
/// UTF-8 JSON string. Call `retrievalkit_string_free` when the caller is done.
///
...
pub(crate) fn run_benchmark(config: BenchmarkConfig) -> Result<BenchmarkReport, BenchError> {
    validate_config(&config)?;
...
pub(crate) fn response_json(response: Result<BenchmarkReport, BenchError>) -> String {
...
pub(crate) struct BenchmarkConfig {
    ...
    pub(crate) encodings: Vec<VectorEncoding>,
    #[serde(with = "metric_json")]
    pub(crate) metric: VectorMetric,
    pub(crate) seed: u64,
    pub(crate) include_unfiltered: bool,
    pub(crate) include_filtered: bool,
    pub(crate) include_persistence: bool,
    pub(crate) include_recall: bool,
    pub(crate) persist_bm25: bool,
    pub(crate) filter_every: Option<usize>,
}
...
pub(crate) struct BenchmarkReport {
    ...
    pub(crate) memory_at_start: Option<ProcessMemorySnapshot>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) memory_at_end: Option<ProcessMemorySnapshot>,
    pub(crate) elapsed_ms: f64,
    pub(crate) runs: Vec<BenchmarkRun>,
}
...
pub(crate) struct BenchmarkRun {
    ...
    pub(crate) filter_every: Option<usize>,
    pub(crate) vector_payload_bytes: usize,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) recall_at_k_vs_f32: Option<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) memory_before_build: Option<ProcessMemorySnapshot>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) memory_after_build: Option<ProcessMemorySnapshot>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) memory_after_search: Option<ProcessMemorySnapshot>,
    pub(crate) total_hits: usize,
    pub(crate) top_hit_checksum: u64,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) persistence: Option<BenchmarkPersistence>,
}

#[derive(Debug, Clone, Serialize)]
pub(crate) struct BenchmarkPersistence {
    pub(crate) persist_bm25: bool,
    pub(crate) save_ms: f64,
    pub(crate) load_ms: f64,
    pub(crate) file_sizes: PersistedFileSizes,
    pub(crate) post_load_search: SearchLatencyStats,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, Serialize)]
pub(crate) struct PersistedFileSizes {
    pub(crate) total_bytes: u64,
    pub(crate) manifest_bytes: u64,
    pub(crate) vectors_bytes: u64,
    pub(crate) chunks_bytes: u64,
    pub(crate) records_bytes: u64,
    pub(crate) bm25_bytes: u64,
    pub(crate) tombstones_bytes: u64,
}
...
#[derive(Debug, Clone, Serialize)]
pub(crate) struct SearchLatencyStats {
    min_ms: f64,
    avg_ms: f64,
    p50_ms: f64,
    p95_ms: f64,
...
pub(crate) enum BenchError {
    ...
    Core(retrievalkit_core::RetrievalKitError),
    Panic,
}
...
impl From<retrievalkit_core::RetrievalKitError> for BenchError {
