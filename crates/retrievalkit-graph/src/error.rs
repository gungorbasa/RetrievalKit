...
impl Display for GraphError {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::Core { message } => write!(f, "RetrievalKit core operation failed: {message}"),
        }
    }
}
...
impl From<retrievalkit_core::RetrievalKitError> for GraphError {
    fn from(error: retrievalkit_core::RetrievalKitError) -> Self {
        match error {
