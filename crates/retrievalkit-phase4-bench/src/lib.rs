...
const FIXTURE_MAGIC: &[u8] = b"RETRIEVALKIT-PHASE4-V1\0";
const POLICY_DESCRIPTOR: &str = concat!(
    "retrievalkit-phase4-device-v1;dimension=384;chunks_per_record=4;",
...
fn usage() -> &'static str {
    "usage: retrievalkit bench phase4 <generate|validate|mac-correctness|measure-stages|preflight> ..."
}
...
fn next_hop_query(
    ...
    seed_index: usize,
    hops: usize,
) -> Result<retrievalkit_graph::GraphResult, String> {
...
fn next_hop_graph_query(
    seed_index: usize,
    hops: usize,
) -> Result<retrievalkit_graph::GraphQuery, String> {
    Ok(
        retrievalkit_graph::GraphQuery::new(Seed::NodeIds(vec![record_node(seed_index)?]))
            .traverse(Traverse {
