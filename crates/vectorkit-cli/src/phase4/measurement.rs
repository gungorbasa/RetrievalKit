...
use vectorkit_core::{Filter, SearchQuery};
use vectorkit_graph::GraphRetrievalDatabase;
...
pub(super) fn run(
    ...
    for encoding in ["f32", "i8"] {
        ...
        super::validate_database_shape(
            ...
            spec,
            if encoding == "f32" {
                vectorkit_core::VectorEncoding::F32
            } else {
                vectorkit_core::VectorEncoding::I8ScalarQuantized
            },
        )?;
