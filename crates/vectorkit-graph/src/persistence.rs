...
use vectorkit_core::{CorpusId, CorpusIndex, ExactVectorIndex, GenerationId};
...
fn load_graph_retrieval_generation(
    ...
    let retrieval =
        vectorkit_core::RetrievalDatabase::load_from_dir(directory.join(RETRIEVAL_DIRECTORY))?;
