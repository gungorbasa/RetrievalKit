...
class Pipeline:
    """Compose shared chunking, caller-provided embeddings, and VectorKit."""
            ...
            chunk_inputs.append(
                {
                    ...
                    "embedding": embedding,
                    "metadata": {
                        "vectorkit.chunk.index": position,
                        "vectorkit.chunk.start_byte": chunk["start_byte"],
                        "vectorkit.chunk.end_byte": chunk["end_byte"],
                    },
                }
            )
