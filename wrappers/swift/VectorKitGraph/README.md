...
`VectorKit` native artifact; never link both native artifacts into one app.
...
swift run --package-path wrappers/swift/VectorKitGraph VectorKitGraphRetrievalQuickstart
```
