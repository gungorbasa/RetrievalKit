...
> [RetrievalKit](../../../README.md) › SDKs › Node.js embedding
...
Node.js 24 callers may use `await using` as a convenience. Explicit
`try`/`finally` works on every supported Node.js release.
